...
"""
    ...
    original mcts library: https://github.com/pbsinclair42/MCTS

    -> includes minor adaptations of library to enable multiple child selection

    normally installed via github, here included as source file to ensure anonymity
